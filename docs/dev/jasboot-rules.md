...
1. **Usar SIEMPRE el archivo `docs/dev/plan/plan.md`** - NO crear nuevas versiones
...
- **SIEMPRE** usar `docs/dev/plan/plan.md`
...
- Buscar en `docs/dev/plan/plan.md` los pasos no completados
...
**El AI DEBE usar `docs/dev/contexto-inteligente.md` para:**
