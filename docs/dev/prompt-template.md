...
- LEE COMPLETAMENTE todos los archivos relevantes ANTES de empezar a trabajar
- USAR SISTEMA DE CONTEXTO INTELIGENTE (docs/dev/contexto-inteligente.md)
- CONSULTAR PATRONES DE ERRORES (docs/dev/error-patterns.md)
- analizar archivos relevantes primero
...
```
usar ai-workflow.md y docs/dev/contexto-inteligente.md
...
- REVISAR docs/dev/plan/plan.md para pasos no completados
...
- **`docs/dev/comandos-rapidos.md`** tiene los comandos específicos
- **`docs/dev/contexto-inteligente.md`** proporciona el sistema de gestión
...
- **`docs/dev/contexto-inteligente.md`** - Sistema de gestión de contexto
- **`docs/dev/comandos-rapidos.md`** - Comandos específicos
- **`docs/dev/error-patterns.md`** - Patrones de errores conocidos
...
- **`docs/dev/contexto-inteligente.md`** - Sistema de gestión avanzado
- **`docs/dev/comandos-rapidos.md`** - Comandos específicos y eficientes
