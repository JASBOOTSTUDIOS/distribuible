...
2.  **Consulta de Patrones**: Leer `docs/dev/error-patterns.md` para evitar errores conocidos del dominio.
...
5.  **Planificación (`plan.md`)**: Crear o actualizar el plan con enfoque en el dominio identificado.
...
1.  **Consultar Patrones**: Revisar `docs/dev/error-patterns.md` para errores conocidos del dominio.
...
- **Usar sistema de contexto inteligente**: Ver `docs/dev/contexto-inteligente.md`
